          ...
          <div className="w-full md:w-1/2">
            <div className="mb-10 lg:mb-20 flex flex-col justify-center items-center gap-8">
              ...
              <p>
                ...
                <br />
                Try searching again or use the go back to the homepage
              </p>

              <NavLink
                to="/"
                className="text-lg font-light  text-white transform transition-all hover:scale-110 bg-custom-heading-color p-5 uppercase hover:bg-custom-dark-blue"
              >
